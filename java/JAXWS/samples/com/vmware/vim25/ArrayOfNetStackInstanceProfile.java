...
/**
 * <p>Java class for ArrayOfNetStackInstanceProfile complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="NetStackInstanceProfile" type="{urn:vim25}NetStackInstanceProfile" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfNetStackInstanceProfile {
     ...
     * This is why there is not a <CODE>set</CODE> method for the netStackInstanceProfile property.
     * 
     * <p>
    ...
    public List<NetStackInstanceProfile> getNetStackInstanceProfile() {
        if (netStackInstanceProfile == null) {
            netStackInstanceProfile = new ArrayList<NetStackInstanceProfile>();
        }
