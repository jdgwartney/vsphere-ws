...
/**
 * <p>Java class for ArrayOfOpaqueNetworkTargetInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="OpaqueNetworkTargetInfo" type="{urn:vim25}OpaqueNetworkTargetInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfOpaqueNetworkTargetInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the opaqueNetworkTargetInfo property.
     * 
     * <p>
    ...
    public List<OpaqueNetworkTargetInfo> getOpaqueNetworkTargetInfo() {
        if (opaqueNetworkTargetInfo == null) {
            opaqueNetworkTargetInfo = new ArrayList<OpaqueNetworkTargetInfo>();
        }
