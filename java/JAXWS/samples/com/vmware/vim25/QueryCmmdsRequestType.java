...
/**
 * <p>Java class for QueryCmmdsRequestType complex type.
 * 
 ...
 *         &lt;element name="queries" type="{urn:vim25}HostVsanInternalSystemCmmdsQuery" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryCmmdsRequestType {
    ...
    public List<HostVsanInternalSystemCmmdsQuery> getQueries() {
        if (queries == null) {
            queries = new ArrayList<HostVsanInternalSystemCmmdsQuery>();
        }
        return this.queries;
    }
