    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.vmware.vim25.VimService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.vmware.vim25.VimService.class.getResource(VimService.class.getSimpleName() + ".class");
