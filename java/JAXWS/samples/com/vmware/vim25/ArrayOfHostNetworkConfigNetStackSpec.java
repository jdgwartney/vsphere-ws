...
/**
 * <p>Java class for ArrayOfHostNetworkConfigNetStackSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostNetworkConfigNetStackSpec" type="{urn:vim25}HostNetworkConfigNetStackSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfHostNetworkConfigNetStackSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostNetworkConfigNetStackSpec property.
     * 
     * <p>
    ...
    public List<HostNetworkConfigNetStackSpec> getHostNetworkConfigNetStackSpec() {
        if (hostNetworkConfigNetStackSpec == null) {
            hostNetworkConfigNetStackSpec = new ArrayList<HostNetworkConfigNetStackSpec>();
        }
